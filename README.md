...
- [ ] Explain what a token is used for.
  ...
  A token is used to provide authentication for an api.

- [ ] What steps can you take in your web apps to keep your data secure?

  Make PrivateRoutes so they can only access the data when there's a token.

- [ ] Describe how web servers work.

  They host sites so others can access them through browser.
